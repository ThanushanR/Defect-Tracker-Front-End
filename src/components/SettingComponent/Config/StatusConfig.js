...
export default class StatusConfig extends React.Component {
  ...
  constructor(props) {
    ...
    onChangeName(e) {
      ...
      getdefectStatus() {
        const url = 'http://192.168.1.60:8081/defectservice/defectstatuses';
        axios.get(url)
    ...
    componentWillMount(){
      ...
      const url ='http://192.168.1.60:8081/defectservices/defectstatuses';
  ...
  editStatus = (id) => {
    ...
    axios.get('http://192.168.1.60:8081/defectservices/defectstatus/' + id)
  ...
  deleteDefect = id => {
    ...
    fetch(`http://192.168.1.60:8081/defectservices/defectstatus/` + id, {
  ...
  handleOk = e => {
    ...
    axios.post('http://192.168.1.60:8081/defectservices/defectstatus/', obj)
    ...
    handleEditOk = (id) => {
      ...
      axios.put(`http://192.168.1.60:8081/defectservices/defectstatus/${id}`, obj)
