...
export default class DefectTypeConfic extends React.Component {
  ...
  getdefectType() {
    const url = 'http://192.168.1.60:8081/defectservices/defecttypes';
    axios.get(url)
  ...
  editDefect = (id) => {
    ...
    axios.get('http://192.168.1.60:8081/defectservices/defecttype/' + id)
  ...
  deleteDefect(id) {
    ...
    fetch(`http://192.168.1.60:8081/defectservices/defecttype/` + id, {
  ...
  handleOk = e => {
    ...
    axios.post('http://192.168.1.60:8081/defectservices/defecttype/', obj)
  ...
  handleEditOk = (id) => {
    ...
    axios.put(`http://192.168.1.60:8081/defectservices/defecttype/${id}`, obj)
