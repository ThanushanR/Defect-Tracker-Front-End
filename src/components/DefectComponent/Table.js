...
const props = {
  name: 'files',
  action: 'http://192.168.1.60:8081/defectservices/uploadMultipleFiles?defectId='+id,
  headers: {
...
class TableFilter extends React.Component {
  ...
  attachment = () => {
    axios.get("http://192.168.1.60:8081/defectservices/listFile/1")
      .then(data => {
        data.data.map(file => {
          if (file.id == 1) {
  ...
  onSubmit(e) {
    ...
    axios.post('http://192.168.1.60:8081/defectservices/comments', commentsu)
      .then(res => {
        console.log(res);
  ...
  refreshDefect() {
    axios
      .get("http://192.168.1.60:8081/defectservices/getAllDefects")
      .then(response => {
  ...
  handleOkAddDefect = e => {
    ...
    axios({
      method: 'post',
      url: 'http://192.168.1.60:8081/defectservices/saveDefect',
      data: defectList,
  ...
  remove = (id) => {
    console.log(id)
    fetch('http://192.168.1.60:8081/defectservices/delete/'+id, {
      method: 'DELETE',
      headers: {
  ...
  getComment() {
    axios.get('http://192.168.1.60:8081/defectservices/comments/1')
      .then(resp => {
  ...
  Preloader(props) {
    ...
    //fetching the employee with get all employee
     getAllDefect = () => {
       const _this = this;
      axios.get('http://192.168.1.60:8081/defectservices/getAllDefects')
      .then(function (response) {
        // handle success
        console.log(response);
    ...
    handleDelete = defectId => {
      ...
      fetch("http://192.168.1.60:8081/defectservices//deleteDefect/{defectId}" + defectId, {
        method: "DELETE",
        headers: {
   ...
   deleteDefect(defectId) {
    console.log(defectId);
    axios
      .delete("http://192.168.1.60:8081/defectservices/deleteDefect/" + defectId)
      .then(response => {
